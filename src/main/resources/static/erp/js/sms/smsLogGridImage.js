function SmsLogGridImage() {
	DateRangeGrid.call(this);

	this.setRecordUrl('smsLog/records');
...
SmsLogGridImage.prototype = Object.create(DateRangeGrid.prototype);
SmsLogGridImage.prototype.constructor = SmsLogGridImage;

SmsLogGridImage.prototype.init = function(container, config) {

	this.initToolbar(container, {
		iconsPath : config.iconsPath,
		xml : "erp/xml/sms/smsLogImageToolbar.xml",
	});

	this.initGrid(container, {
		imageUrl : config.imageUrl,
		xml : "erp/xml/sms/smsLogGrid.xml",
	});

};

SmsLogGridImage.prototype.onInitedGrid = function(grid) {
...
SmsLogGridImage.prototype.onInitedToolbar = function(toolbar) {
	...
	toolbar.addText('cb1', 6, '<div id="combo3" style="width:100px; height:30px; margin-top:-3px;">');
	var combo = new dhtmlXCombo("combo3", "cmb", 100);
	combo.readonly(true);
...
//	this.combos.push( combo );
	...
	*/
	...
	toolbar.addText('cb1', 8, '<div id="radio3" style="width:360px; height:30px; margin-top:-9px;">');
	...
	var radio = new dhtmlXForm("radio3", radioFormData);
...
SmsLogGridImage.prototype.setCustomerCode = function(customerCode) {
	this.customerCode = customerCode;
};

SmsLogGridImage.prototype.onBeforeParams = function(params) {
