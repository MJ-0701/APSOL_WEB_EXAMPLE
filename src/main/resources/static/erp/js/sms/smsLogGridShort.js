function SmsLogGridShort() {
	DateRangeGrid.call(this);

	this.setRecordUrl('oshotsms/records');
...
SmsLogGridShort.prototype = Object.create(DateRangeGrid.prototype);
SmsLogGridShort.prototype.constructor = SmsLogGridShort;

SmsLogGridShort.prototype.init = function(container, config) {

	this.initToolbar(container, {
		iconsPath : config.iconsPath,
		xml : "erp/xml/sms/smsLogShortToolbar.xml",
	});
...
SmsLogGridShort.prototype.onInitedGrid = function(grid) {
...
SmsLogGridShort.prototype.onInitedToolbar = function(toolbar) {
...
SmsLogGridShort.prototype.setCustomerCode = function(customerCode) {
	this.customerCode = customerCode;
};

SmsLogGridShort.prototype.onBeforeParams = function(params) {
