function SmsLogGridLong() {
	DateRangeGrid.call(this);

	this.setRecordUrl('oshotmms/records');
...
SmsLogGridLong.prototype = Object.create(DateRangeGrid.prototype);
SmsLogGridLong.prototype.constructor = SmsLogGridLong;

SmsLogGridLong.prototype.init = function(container, config) {

	this.initToolbar(container, {
		iconsPath : config.iconsPath,
		xml : "erp/xml/sms/smsLogLongToolbar.xml",
	});
...
SmsLogGridLong.prototype.onInitedGrid = function(grid) {
...
SmsLogGridLong.prototype.onInitedToolbar = function(toolbar) {
	...
	toolbar.addText('cb1', 6, '<div id="combo2" style="width:100px; height:30px; margin-top:-3px;">');
	var combo = new dhtmlXCombo("combo2", "cmb", 100);
	combo.readonly(true);
...
//	this.combos.push( combo );
	...
	*/
	...
	toolbar.addText('cb1', 8, '<div id="radio2" style="width:360px; height:30px; margin-top:-9px;">');
	...
	var radio = new dhtmlXForm("radio2", radioFormData);
...
SmsLogGridLong.prototype.setCustomerCode = function(customerCode) {
	this.customerCode = customerCode;
};

SmsLogGridLong.prototype.onBeforeParams = function(params) {
