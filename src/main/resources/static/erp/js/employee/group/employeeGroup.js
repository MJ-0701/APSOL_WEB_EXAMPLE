function EmployeeGroup() {
	...
	this.setUrlPrefix('employeeGroup');

}
EmployeeGroup.prototype = Object.create(DataGrid.prototype);
EmployeeGroup.prototype.constructor = EmployeeGroup;

EmployeeGroup.prototype.init = function(container, config) {

	this.initToolbar(container, {
		iconsPath : config.iconsPath,
		xml : "erp/xml/employee/group/toolbar.xml",
	});

	this.initGrid(container, {
		imageUrl : config.imageUrl,
		xml : "erp/xml/employee/group/grid.xml",
	});

};

EmployeeGroup.prototype.addRow = function() {
	var me = this;
	insertRow(this.grid, "employeeGroup/insert", 'name', 0, function(grid, id, data) {
...
EmployeeGroup.prototype.onInitedGrid = function(grid) {
