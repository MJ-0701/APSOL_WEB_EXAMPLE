function PointVcntCheckForm(container) {

	DataForm.call(this);

	this.setUrlPrefix('point');

	this.form;
};

PointVcntCheckForm.prototype = Object.create(DataForm.prototype);
PointVcntCheckForm.prototype.constructor = PointVcntCheckForm;

PointVcntCheckForm.prototype.init = function(container, enableToolbar) {
	...
	this.initForm(layout.cells('a'), {
		xml : 'erp/xml/point/pointVcntCheckForm.xml',
	});
...
PointVcntCheckForm.prototype.onInitedForm = function(form) {
