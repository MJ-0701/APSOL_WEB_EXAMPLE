function CustomerGroup() {
	...
	this.setUrlPrefix('customerGroup');

}
CustomerGroup.prototype = Object.create(DataGrid.prototype);
CustomerGroup.prototype.constructor = CustomerGroup;

CustomerGroup.prototype.init = function(container, config) {

	this.initToolbar(container, {
		iconsPath : config.iconsPath,
		xml : "erp/xml/customer/group/toolbar.xml",
	});

	this.initGrid(container, {
		imageUrl : config.imageUrl,
	//	xml : "erp/xml/customer/group/grid.xml",
		xml : 'customerGroup/grid'
	});

};

CustomerGroup.prototype.addRow = function() {
	var me = this;
	insertRow(this.grid, "customerGroup/insert", 'name', 0, function(grid, id, data) {
...
CustomerGroup.prototype.onInitedGrid = function(grid) {
	DataGrid.prototype.onInitedGrid.call(this, grid);

	// me.grid.attachHeader("#select_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#select_filter,");
