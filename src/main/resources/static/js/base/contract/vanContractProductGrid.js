function VanContractProductGrid(container, config) {
	...
	function setupToolbar() {
		...
		toolbar.attachEvent("onClick", function(id) {
			...
			case 'btnAdd':
				...
				insertRowWithIndex(grid, "newContract/insertProduct", 'no', 0, index++, function(grid, id, data) {
				...
				dhtmlx.confirm({
					...
					callback : function(r) {
						if (r) {
							...
							$.post('newContract/deleteProduct', {
