function AddJobListGrid(container, config) {
	...
	this.getReturnTest = function(returnValue) {
		insertJobListRow(grid, "businessContactInfo/addJobList", "no", 0, index++, returnValue, function(grid, id, data) {
	...
	function setupToolbar() {
		...
		toolbar.attachEvent("onClick", function(id) {
			...
			case 'btnAdd':
				...
				// Form에서 가맹점 정보로 customerId 찾아와야 함.
				var customerId = businessContactForm.getCustomerId();
				openAddProject(customerId);
				...
				dhtmlx.confirm({
					...
					callback : function(r) {
						if (r) {
							...
							$.post('businessContactInfo/deleteAddedJobList', {
