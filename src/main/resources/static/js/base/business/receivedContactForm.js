function ReceivedContactForm(container, config) {
	...
	function reload() {
		...
		$.get('receivedBusinessContact/info', {
			code : entityId
		}, function(data) {
	...
	this.init = function() {
		...
		toolbar.loadStruct('xml/base/businessContact/receivedFormToolbar.xml', function() {
