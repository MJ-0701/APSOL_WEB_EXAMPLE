function CommentForm(container, config) {
	...
	this.init = function() {
		...
		toolbar.loadStruct('xml/base/approvalReference/commentFormToolbar.xml', function() {
		...
		form.loadStruct('xml/base/approvalReference/commentForm.xml', function() {
