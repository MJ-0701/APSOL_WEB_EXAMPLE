function FormCompanyAuthPopup(form, name, onSelected, onReload) {

	var params = '';
	var recordUrl = 'popup/companyAuth/records';
	var searchUrl = 'popup/companyAuth/search';
	...
	function setupGrid(pop) {
		...
		grid.load('xml/popup/companyAuth/grid.xml', function() {
