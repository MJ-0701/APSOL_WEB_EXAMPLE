function FormStoreAuthPopup(form, name, onSelected, onReload) {

	var params = '';
	var recordUrl = 'popup/storeAuth/records';
	var searchUrl = 'popup/storeAuth/search';
	...
	function setupGrid(pop) {
		...
		grid.load('xml/popup/storeAuth/grid.xml', function() {
