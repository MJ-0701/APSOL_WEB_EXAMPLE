function FormEmployeeAuthPopup(form, name, onSelected, onReload) {

	var params = '';
	var recordUrl = 'popup/employeeAuth/records';
	var searchUrl = 'popup/employeeAuth/search';
	...
	function setupGrid(pop) {
		...
		grid.load('xml/popup/employeeAuth/grid.xml', function() {
